...
export class CurriculumSeedService implements OnApplicationBootstrap {
  ...
  async seedAll() {
    this.logger.log(
      'Seeding Master Boards, Curriculums, Subject Groups & Subjects...',
    );
    ...
    const globalSubjectsData = [
      {
        code: 'ENG',
        name: 'English',
        category: SubjectClassification.LANGUAGE,
      },
      ...
      },
      {
        code: 'MAT',
        name: 'Mathematics',
        category: SubjectClassification.CORE,
      },
      {
        code: 'EVS',
      ...
      { code: 'GEO', name: 'Geography', category: SubjectClassification.CORE },
      {
        code: 'ECO',
        name: 'Economics',
        category: SubjectClassification.ELECTIVE,
      },
      {
        code: 'COMM',
      ...
      },
      {
        ...
        category: SubjectClassification.VOCATIONAL,
      },
      {
        code: 'AI',
      ...
      },
      {
        code: 'ART',
        name: 'Art Education',
        category: SubjectClassification.CO_CURRICULAR,
      },
      {
        code: 'MUSIC',
        name: 'Music',
      ...
      },
      {
        ...
        category: SubjectClassification.INTERNAL_ASSESSMENT,
      },
      {
        code: 'VAL_ED',
        name: 'Value Education',
        category: SubjectClassification.ADDITIONAL,
      },
      {
        code: 'SUPW',
        name: 'SUPW & Community Service',
        category: SubjectClassification.INTERNAL_ASSESSMENT,
      },
      {
        code: 'ROBOTICS',
    ...
    const boards = [
      {
        ...
        stateCode: null,
        description:
          'National board of education in India for public and private schools.',
      },
      {
        code: 'CISCE',
        ...
        stateCode: null,
        description:
          'National level private board of school education in India conducting the ICSE examination.',
      },
      {
        code: 'STATE_AP',
        ...
        stateCode: 'AP',
        description:
          'Directorate of Government Examinations, Andhra Pradesh (SSC Curriculum).',
      },
      {
        code: 'STATE_TS',
        ...
        stateCode: 'TS',
        description:
          'Directorate of Government Examinations, Telangana (SSC Curriculum).',
      },
    ];
    ...
    const curriculums = [
      {
        ...
        version: '2026-27',
        description:
          'Comprehensive CBSE framework for Classes 1 to 10 following NEP 2020 guidelines.',
      },
      {
        boardCode: 'CISCE',
        code: 'ICSE_2026',
        ...
        version: '2026-27',
        description:
          'CISCE ICSE academic framework for Classes 1 to 10 with Groups I, II, and III selection structure.',
      },
      {
        boardCode: 'STATE_AP',
        code: 'AP_SSC_2026',
        ...
        version: '2026-27',
        description:
          'SCERT Andhra Pradesh state curriculum with bifurcated Physical & Biological Sciences in Classes 8-10.',
      },
      {
        boardCode: 'STATE_TS',
        code: 'TS_SSC_2026',
        ...
        version: '2026-27',
        description:
          'SCERT Telangana state curriculum with 3-language formula and core sciences for Classes 1-10.',
      },
    ];
    ...
    await this.seedCbseCurriculum(
      curriculumMap.get('CBSE_2026')!,
      globalSubjectMap,
    );
    await this.seedIcseCurriculum(
      curriculumMap.get('ICSE_2026')!,
      globalSubjectMap,
    );
    await this.seedApCurriculum(
      curriculumMap.get('AP_SSC_2026')!,
      globalSubjectMap,
    );
    await this.seedTsCurriculum(
      curriculumMap.get('TS_SSC_2026')!,
      globalSubjectMap,
    );
  ...
  // -------------------------------------------------------------
  private async seedCbseCurriculum(
    curriculumId: string,
    ...
    const groups = [
      ...
      {
        code: 'MAIN_SUBJECTS',
        name: 'Main Academic Subjects',
        minSelection: 3,
        isRequired: true,
        sortOrder: 2,
      },
      {
        code: 'SKILL_ELECTIVES',
        name: 'Skill Electives (Group S)',
        minSelection: 0,
        maxSelection: 1,
        isRequired: false,
        sortOrder: 3,
      },
      {
        ...
        name: 'Internal Assessment (Co-Scholastic)',
        minSelection: 2,
        isRequired: true,
        sortOrder: 4,
      },
      {
        code: 'CO_CURRICULAR',
        name: 'Co-Curricular & Other School Activities',
        minSelection: 0,
        isRequired: false,
        sortOrder: 5,
      },
    ...
    const subjects = [
      // Primary (1-5)
      {
        ...
        gFrom: 1,
        gTo: 5,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.MANDATORY,
        grp: 'LANGUAGES',
        periods: 6,
        maxM: 100,
        passM: 35,
      ...
      },
      {
        gs: 'TEL',
        code: 'CBSE-TEL-PRI',
        name: 'Regional Language (Telugu)',
        gFrom: 1,
        gTo: 5,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.OPTIONAL,
        grp: 'LANGUAGES',
        periods: 4,
        maxM: 100,
        passM: 35,
      },
      {
        ...
        gFrom: 1,
        gTo: 5,
        type: SubjectClassification.CORE,
        sel: SubjectSelectionType.MANDATORY,
        grp: 'MAIN_SUBJECTS',
        periods: 6,
        maxM: 100,
      ...
      },
      {
        ...
        gFrom: 1,
        gTo: 5,
        type: SubjectClassification.ADDITIONAL,
        sel: SubjectSelectionType.OPTIONAL,
        grp: 'CO_CURRICULAR',
        periods: 2,
        maxM: 50,
      ...
      },
      {
        ...
        gFrom: 1,
        gTo: 5,
        type: SubjectClassification.CO_CURRICULAR,
        sel: SubjectSelectionType.MANDATORY,
        grp: 'CO_CURRICULAR',
        periods: 2,
        maxM: 50,
      ...
      },
      {
        ...
        gFrom: 1,
        gTo: 5,
        type: SubjectClassification.INTERNAL_ASSESSMENT,
        sel: SubjectSelectionType.MANDATORY,
        grp: 'INTERNAL_ASSESSMENT',
        periods: 2,
        maxM: 50,
        passM: 18,
        exam: false,
      ...
      },
      {
        gs: 'TEL',
        code: 'CBSE-TEL-MID',
        name: 'Third Language (Telugu)',
        gFrom: 6,
        gTo: 8,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.CHOICE,
        grp: 'LANGUAGES',
        periods: 4,
        maxM: 100,
        passM: 33,
      ...
      },
      {
        ...
        gFrom: 6,
        gTo: 8,
        type: SubjectClassification.VOCATIONAL,
        sel: SubjectSelectionType.OPTIONAL,
        grp: 'SKILL_ELECTIVES',
        periods: 2,
        maxM: 50,
      ...
      },
      {
        ...
        gTo: 10,
        type: SubjectClassification.VOCATIONAL,
        sel: SubjectSelectionType.ELECTIVE,
        grp: 'SKILL_ELECTIVES',
        periods: 4,
        maxM: 100,
        passM: 33,
      ...
      },
      {
        gs: 'PHE',
        code: '506',
        name: 'Health & Physical Education (506)',
        gFrom: 9,
        gTo: 10,
        type: SubjectClassification.INTERNAL_ASSESSMENT,
        sel: SubjectSelectionType.MANDATORY,
    ...
    await this.upsertCurriculumSubjects(
      curriculumId,
      subjects,
      groupMap,
      gsMap,
  ...
  // -------------------------------------------------------------
  private async seedIcseCurriculum(
    curriculumId: string,
    gsMap: Map<string, string>,
  ) {
    const groups = [
      {
        code: 'GROUP_I',
        name: 'Group I (Compulsory Subjects)',
        minSelection: 3,
        maxSelection: 3,
        isRequired: true,
        sortOrder: 1,
      ...
      {
        code: 'GROUP_III',
        name: 'Group III (Applied & Technical - Any 1)',
        minSelection: 1,
        maxSelection: 1,
        isRequired: true,
        sortOrder: 3,
      ...
      {
        code: 'LOWER_GRADES',
        name: 'Junior Academic Framework (Classes 1-8)',
        minSelection: 0,
        isRequired: false,
        sortOrder: 5,
      },
    ...
    const subjects = [
      ...
      },
      {
        gs: 'HIS_CIV',
        code: 'ICSE-03',
        name: 'History, Civics & Geography (H.C.G.)',
        gFrom: 9,
        gTo: 10,
        type: SubjectClassification.CORE,
        sel: SubjectSelectionType.MANDATORY,
      ...
      },
      {
        ...
        gFrom: 9,
        gTo: 10,
        type: SubjectClassification.ELECTIVE,
        sel: SubjectSelectionType.ELECTIVE,
        grp: 'GROUP_II',
        periods: 5,
        maxM: 100,
      ...
      // Internal SUPW
      {
        gs: 'SUPW',
        code: 'ICSE-SUPW',
        name: 'Socially Useful Productive Work (SUPW)',
        gFrom: 9,
        gTo: 10,
        type: SubjectClassification.INTERNAL_ASSESSMENT,
        sel: SubjectSelectionType.MANDATORY,
  ...
  // -------------------------------------------------------------
  private async seedApCurriculum(
    curriculumId: string,
    gsMap: Map<string, string>,
  ) {
    const groups = [
      ...
      {
        code: 'SCHOOL_ADDITIONAL',
        name: 'School-Level & Co-Curricular Offerings',
        minSelection: 0,
        isRequired: false,
        sortOrder: 3,
      },
    ...
    const subjects = [
      ...
      // Classes 6-7
      {
        gs: 'TEL',
        code: 'AP-01T-M',
        name: 'First Language (Telugu / Composite)',
        gFrom: 6,
        gTo: 7,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.MANDATORY,
      ...
      // Classes 8-10 (AP SSC with bifurcated Physical & Biological Science)
      {
        gs: 'TEL',
        code: '01T',
        name: 'First Language (Telugu 01T)',
        gFrom: 8,
        gTo: 10,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.CHOICE,
      ...
      },
      {
        gs: 'HIN',
        code: '09H',
        name: 'Second Language (Hindi 09H)',
        gFrom: 8,
        gTo: 10,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.MANDATORY,
      ...
      },
      {
        gs: 'ENG',
        code: '13E',
        name: 'Third Language (English 13E)',
        gFrom: 8,
        gTo: 10,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.MANDATORY,
  ...
  // -------------------------------------------------------------
  private async seedTsCurriculum(
    curriculumId: string,
    gsMap: Map<string, string>,
  ) {
    const groups = [
    ...
    const subjects = [
      ...
      // Classes 6-7
      {
        gs: 'TEL',
        code: 'TS-01T-M',
        name: 'First Language (Telugu / Urdu)',
        gFrom: 6,
        gTo: 7,
        type: SubjectClassification.LANGUAGE,
        sel: SubjectSelectionType.MANDATORY,
